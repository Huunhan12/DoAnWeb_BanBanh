...
<head>
    ...
    <meta name="description" content="Lu Cake Shop - Tiệm bánh ngọt cao cấp, bánh kem sinh nhật, bánh Pháp, cupcake, cookie">
    <title><?php echo isset($tieuDeTrang) ? $tieuDeTrang . ' | Lu Cake Shop' : 'Lu Cake Shop - Tiệm Bánh Ngọt Cao Cấp'; ?></title>
    <!-- Bootstrap 5 CSS -->
    ...
    <!-- Custom CSS - Tách theo chức năng -->
    <link href="<?php echo layURLGoc(); ?>/assets/css/bien-co-so.css" rel="stylesheet">
    <link href="<?php echo layURLGoc(); ?>/assets/css/bo-cuc.css" rel="stylesheet">
    <link href="<?php echo layURLGoc(); ?>/assets/css/banner-trang-chu.css" rel="stylesheet">
    <link href="<?php echo layURLGoc(); ?>/assets/css/san-pham.css" rel="stylesheet">
    <link href="<?php echo layURLGoc(); ?>/assets/css/gio-hang.css" rel="stylesheet">
    <link href="<?php echo layURLGoc(); ?>/assets/css/thanh-phan.css" rel="stylesheet">
    <link href="<?php echo layURLGoc(); ?>/assets/css/chan-trang.css" rel="stylesheet">
    <link href="<?php echo layURLGoc(); ?>/assets/css/tuong-thich.css" rel="stylesheet">
</head>
<body>
    <!-- Top Bar -->
    <div class="top-bar">
